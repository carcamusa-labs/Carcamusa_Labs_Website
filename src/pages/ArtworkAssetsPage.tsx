...
export function ArtworkAssetsPage() {
  ...
  return (
    <InnerPageLayout titleKey="pageTitle.artwork">
      <h2>{t("artwork.heading")}</h2>

      <CollapsibleSection title={t("artwork.collapsibleArt")}>
      ...
      {isMobile && lightbox ? (
        <div className="art-lightbox-backdrop" role="presentation" onClick={closeLightbox}>
          <div
      ...
      <h2>{t("artwork.toolsHeading")}</h2>

      <CollapsibleSection title={t("artwork.collapsibleTools")}>
